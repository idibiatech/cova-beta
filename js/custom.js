...
$(function() {
  ...
  if(bgndKenburns.length){
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "img/backgrounds/1080x1440-c1-kenburns-1.jpg" },
        { src: "img/backgrounds/1080x1440-c1-kenburns-2.jpg" },
        { src: "img/backgrounds/1080x1440-c1-kenburns-3.jpg" }
      ],
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2024, 2, 21), format: 'D'});
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2024, 2, 21), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
